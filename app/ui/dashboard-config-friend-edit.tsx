	...
	return (
		<>
			<div className="space-y-4">
				...
				<div>
					<label className="mb-2 block font-semibold">社交地址</label>
				...
				<div className="flex items-center space-x-2">
					...
					/>
					<label htmlFor="pinned" className="cursor-pointer select-none">
						置顶
					</label>
				</div>
			...
			<Suspense
				fallback={
					<div className="space-y-4">
						...
						{[...Array(1)].map((_, i) => (
							<div key={`skeleton-${i}`}>
								<div className="border-foreground/20 transition-border focus-within:border-foreground/50 relative mb-3 rounded-lg border p-3 shadow-xs duration-200">
									<div className="grid grid-cols-1 gap-3 sm:grid-cols-4">
										<div>
											<Skeleton className="mb-2 h-5 w-18" />
