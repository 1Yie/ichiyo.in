...
export default function DashboardProfile() {
    ...
    const handleSubmitName = async () => {
        ...
        try {
            ...
            toast.error("修改用户名失败: " + (error instanceof Error ? error.message : ""));
        }
    };
    // 修改密码提交
    ...
    const handleGenerateKey = async () => {
        try {
            ...
            const isNewKey = registerKey.id !== data.id; // 通过ID判断是否为新密钥
            ...
            toast.error("生成密钥失败: " + (error instanceof Error ? error.message : ""));
        }
    };
                ...
                <div className="bg-muted/50 flex-1 rounded-xl p-4">
                    <div className="w-full h-full bg-white dark:bg-muted/50 p-4 rounded-xl">
                        ...
                        <div className="flex justify-between items-center bg-muted/50 rounded-2xl p-3">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex flex-col gap-2">
                                    <p className="text-lg text-foreground">{userInfo.name}</p>
                        ...
                        {isAdmin.isAdmin && (
                            <>
                                <hr className="my-4 bg-foreground/30" />
                                <h1 className="text-2xl font-bold mb-4 text-foreground/90">高级设置</h1>
                                <div className="bg-muted/50 rounded-2xl p-3">
                                    ...
                                    <p className="text-sm text-foreground/80">有效期为 3 分钟，且为一次性使用。</p>
                                    <p className="text-sm text-foreground/80">当密钥被使用后，需等待上一个密钥过期后才能生成新密钥。</p>
            ...
            <AlertDialog open={showEditDialog} onOpenChange={setShowEditDialog}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>你可以修改你的用户名。</AlertDialogDescription>
                    </AlertDialogHeader>
                    ...
                    <AlertDialogFooter className="mt-6">
                        ...
                        <AlertDialogAction onClick={handleSubmitName}>提交</AlertDialogAction>
                    </AlertDialogFooter>
                </AlertDialogContent>
            </AlertDialog>
            ...
            <AlertDialog open={showPasswordDialog} onOpenChange={(open) => {
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>请输入新密码，密码长度至少6位。</AlertDialogDescription>
                    </AlertDialogHeader>
            ...
            <AlertDialog open={showAdminDialog} onOpenChange={setShowAdminDialog}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>在此添加新的管理员邮箱。</AlertDialogDescription>
                    </AlertDialogHeader>
